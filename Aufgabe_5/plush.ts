namespace Aufgabe_5 {
    ...
    const plushtag: HTMLElement = document.getElementById("shop3") as HTMLDivElement;

    
    for (let i: number = 0; i <= gsmtSortiment.length - 1; i++) {
        if (gsmtSortiment[i].kategorie2 === "Plush") {
            let div: HTMLDivElement = document.createElement("div"); //new div an #shop3
...
}        /* if (sortiment2[index].kategorie1) { 
